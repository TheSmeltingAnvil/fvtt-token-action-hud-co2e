...
export interface MockRegion extends foundry.documents.RegionDocument {
  id: string;
  name: string;
  //   shapes: any[];
...
export interface MockActor extends foundry.documents.Actor {
  id: string;
  name: string;
  type: string;
  uuid: string;
...
export interface MockItem extends foundry.documents.Item<MockActor> {
  id: string;
  name: string;
  type: string;
  system: any;
